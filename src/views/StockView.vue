<script setup lang="ts">
    ...
    const livraisons = ref<Livraison[]>([
        ...
        { livraison_id: 2, user: utilisateur.value, bar: "bar 2",product:{ name: 'Product B', quantity: 15, maxQuantity: 20 },state: 'en_cours' ,date_livraison: new Date()},
        { livraison_id: 3, user: utilisateur.value, bar: "bar 2",product:{ name: 'Product B', quantity: 15, maxQuantity: 20 },state: 'terminer' ,date_livraison: new Date() },
    ]);
